...
static void aw86224fcr_write_amplitude(uint8_t amplitude, uint32_t duration_ms) {
    aw86224fcr_go();
    for (uint32_t i = 0; i < duration_ms * 12; i++)
...
const vibration_motor_api_t aw86224fcr = {.init = aw86224fcr_init,
